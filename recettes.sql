...
CREATE TABLE IF NOT EXISTS `categorie` (
  ...
  `type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL DEFAULT '',
...
-- Listage des données de la table recette_anne.ingredient : ~35 rows (environ)
...
-- Listage des données de la table recette_anne.ingredientparrecette : ~2 rows (environ)
...
-- Listage des données de la table recette_anne.recette : ~10 rows (environ)
INSERT INTO `recette` (`id_recette`, `nomRecette`, `tempsPrepa`, `instructions`, `id_categorie`) VALUES
	(1, 'Salade tomate mozza', 20, 'Couper les tomates en tranches, ajouter la mozza, le basilic et assaisonner avec l\'huile d\'olive, sel et poivre', 0),
	(2, 'Tartines de formage de chèvre et miel', 25, 'Faire griller le pain de campagne, ajouter du fromage de chèvre, du miel et des noix, garnir de roquette', 0),
	(3, 'Soupe froide de concombre et yahourt', 30, 'Mixer le concombre, ajouter le yahourt nature, l\'ail et la menthe, assaisonner avec set et poivre', 0),
	(4, 'Salade de quinoa et légumes grillés', 40, 'Cuire le quinoa et faire griller les légumes (poivrons, courgettes, aubergones). mélanger la feta et assaisonner avec l\'huile d\'olive, sel et poivre.', 0),
	(5, 'Pâtes sauce tomate et basilic', 25, 'Cuire les pâtes, chauffer la sauce tomate avec l\'ail et le basilic puis mélanger avec les pâtes', 0),
	(6, 'Omelette aux épinards et formage râpé', 20, 'Cuire les épinards dans une poêle, ajouter les oeufs battus et le fromage râpés, cuire jusqu\'à ce que l\'omelette soit bien dorée', 0),
	(7, 'Poulet curry avec riz basmati', 45, 'Cuire le poulet dans le curry en poudre et le lait de coco, servir avec du riz basmati.', 0),
	(8, 'Tarte aux pommes simple', 50, 'Cuire la pâte brisée, disposer les pommes tranchées, saupoudrer de sucre et de canelle, puis cuir au four', 0),
	(9, 'Crêpes sucrées à la confiture de fraises', 30, 'Préparer la pâte à crêpes, cuire les crêpes puis les garnie de confiture de fraises', 0),
	(10, 'Compote de pommes maison', 40, 'Faire cuire les pommes avec du sucre et de la canelle puis mixer pour obtenir une compote', 0);
